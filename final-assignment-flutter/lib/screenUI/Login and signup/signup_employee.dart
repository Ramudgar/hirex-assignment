...
class _SignupEmployeeState extends State<SignupEmployee> {
  ...
  _employeeRegister(User user) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Employee Signup Page'),
        elevation: 0,
        centerTitle: true,
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: const Color.fromARGB(255, 56, 69, 244)
                          .withOpacity(0.7),
                      spreadRadius: 3,
                      blurRadius: 2,
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    'http://hrdailyadvisor.blr.com/app/uploads/sites/3/2017/02/Productive-Happy-Workers.jpg',
                    fit: BoxFit.cover,
                    height: height * 0.3,
                    width: width * 0.9,
                  ),
